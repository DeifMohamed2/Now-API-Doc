...
sidebarTitle: "Errors"
description: "Full error reference for the Now Shipping Public API v1: HTTP status codes, machine-readable error codes, validation messages, and troubleshooting steps."
---
