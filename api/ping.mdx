---
title: "GET /ping — Health Check and API Key Verification"
sidebarTitle: "GET /ping"
description: "Verify your API key is valid and active. Returns account info, company status, and enabled scopes. No scope required."
---
