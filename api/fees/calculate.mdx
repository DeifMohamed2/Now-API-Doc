---
title: "POST /fees/calculate — Preview Shipping Fee for an Order"
sidebarTitle: "Calculate Fee"
description: "Calculate the shipping fee for a given governorate and order type. Preview the EGP cost before creating an order — never send this value in requests."
---
