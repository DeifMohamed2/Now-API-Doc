---
title: "POST /orders — Create a Shipping Order"
sidebarTitle: "POST /orders"
description: "Create a Deliver, Return, or Exchange order. Requires exact zone from /delivery-zones catalog. Fees are computed server-side."
---
