---
title: "DELETE /orders/{orderId} — Delete an Order by ID"
sidebarTitle: "Delete Order"
description: "Permanently delete a new-status order. Orders that have progressed past new status must go through the cancel endpoint instead of delete."
---
