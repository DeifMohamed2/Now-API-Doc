---
title: "GET /orders/{orderNumber} — Get Full Order Details"
sidebarTitle: "Get Order"
description: "Retrieve complete details for a single order by its 6-digit order number, including status labels, tracking stages, and pickup address."
---
