---
title: "POST /pickups/{pickupNumber}/cancel — Cancel a Pickup"
sidebarTitle: "POST /cancel"
description: "Cancel a scheduled pickup by pickup number. Cancellation eligibility depends on current pickup status."
---
