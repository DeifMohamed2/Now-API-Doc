---
title: "PUT /pickups/{pickupNumber} — Update a Scheduled Pickup"
sidebarTitle: "PUT /pickups/{n}"
description: "Update an existing pickup while it is in 'new' or 'pendingPickup' status. Pickup fees are recomputed automatically on update."
---
