---
title: "Calculate Pickup Fee — POST /pickups/calculate-fee"
sidebarTitle: "Calculate Fee"
description: "Preview the pickup fee before scheduling. Pass numberOfOrders for an accurate EGP estimate. Never send the returned fee in create or update requests."
---
