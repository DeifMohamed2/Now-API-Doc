---
title: "Retrieve Pickup Details — GET /pickups/{pickupNumber}"
sidebarTitle: "Get Pickup"
description: "Retrieve full pickup details by pickup number, including status, fees, and the linked pickup address the courier will visit on the scheduled date."
---
