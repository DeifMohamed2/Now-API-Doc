---
title: "DELETE /pickups/{pickupNumber} — Delete a Pickup"
sidebarTitle: "DELETE /pickups/{n}"
description: "Permanently delete a pickup in 'new' or 'pendingPickup' status. Pickups past these states must be cancelled, not deleted."
---
