---
title: "POST /pickups — Schedule a Courier Pickup"
sidebarTitle: "POST /pickups"
description: "Schedule a courier pickup for a merchant location. Requires a valid future pickupDate and numberOfOrders. Fees are computed server-side."
---
