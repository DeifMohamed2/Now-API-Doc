---
title: "Integration Best Practices and Go-Live Checklist"
sidebarTitle: "Best Practices"
description: "Checklist and recommendations for a reliable Now Shipping API integration: zone caching, fee handling, merchant ID storage, error logging."
---
...
- [ ] Replace `https://your-domain.com` with `https://now.com.eg` in all request URLs before go-live
...
<Tip>
  **Use `GET /ping` for health checks and API key validation.** This endpoint requires no scope, returns your account identity and active scopes, and costs nothing — make it your first call in monitoring scripts and CI/CD pre-flight checks.
</Tip>
