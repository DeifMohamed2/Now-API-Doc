---
title: "Authenticate with Now Shipping API"
sidebarTitle: "Authentication"
description: "All Now Shipping API requests require a valid API key. Pass it as a Bearer token or X-Api-Key header on every call."
---
